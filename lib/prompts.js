...
export const FONT_AND_BACKGROUND_PROMPT = `
    Analyze the image and detect the title font and background of image used. Please provide the details strictly in JSON format with no additional explanation or comments. :  
    ...
    Please ensure that the output strictly matches this JSON structure without any extra information.
`;
