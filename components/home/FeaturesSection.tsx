            ...
            <div className=" h-[400px] w-[320px] sm:w-[500px] shadow-lg dark:shadow-neutral-950 bg-white dark:bg-neutral-900 border dark:border-neutral-800 rounded-md">
              <div className=" px-3 sm:px-5 w-full h-full flex justify-center items-center">
                <div className=" relative">
                  ...
                  {/* bg description */}
                  <div className=" absolute bg-white dark:bg-neutral-800 text-neutral-800 dark:text-white text-xs sm:text-sm shadow-lg dark:shadow-neutral-950 px-2 py-0.5 rounded-sm left-[90px] -bottom-[40px] sm:left-40 sm:-bottom-5">
                    Font Size: 24px
                  </div>
