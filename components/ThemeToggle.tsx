...
export function ThemeToggle() {
  ...
  return (
    <button
      className=" flex gap-2 sm:gap-3 p-1 rounded-sm shadow-md bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700/60 hover:shadow-lg hover:bg-neutral-50/60 transition-all duration-200 hover:scale-105"
